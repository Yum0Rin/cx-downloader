...
class App(ctk.CTk):
    ...
    def _build_options(self, parent):
        ...
        for text, var in (
            ...
            ctk.CTkCheckBox(
                row4, text=text, variable=var, command=self._update_preview,
                width=lv_font.measure(text) + 38, height=28,
                checkbox_width=18, checkbox_height=18, corner_radius=5,
                font=lv_font, text_color=pair("text"),
